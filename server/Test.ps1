...
java -cp $cp net.minecraft.client.main.Main --version 1.21.8 --assetsDir assets -assetIndex assets\indexes26.json --uuid $login.profile.id --username $login.profile.name --accessToken $login.token
